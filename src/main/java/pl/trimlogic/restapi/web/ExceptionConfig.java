...
class ExceptionConfig {
    @NonNull @Getter(AccessLevel.PACKAGE) private final String logMessage;
    @NonNull private String responseMessage;
    @NonNull @Getter(AccessLevel.PACKAGE) private final HttpStatus httpStatus;
    @Getter(AccessLevel.PACKAGE) private LogLevel logLevel = LogLevel.ERROR;
